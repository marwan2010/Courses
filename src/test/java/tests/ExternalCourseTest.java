...
public class ExternalCourseTest extends TestBase {
	...
	public void CourseInformantion() throws InterruptedException, IOException {
		...
		driver.get("https://sang.greenboard.online/courses/coursesActions/4");
		homeObj.Coursetite("Course External"+"-" +faker.book().title());
		...
		homeObj.code("C0de-IE-0004"+faker.book().hashCode());
